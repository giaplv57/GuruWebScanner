...
function shellDetectorMain($dirname, $resFile) {
    ...
    // TungPun new
    $shelldetector->setDir($dirname, $resFile);    
...
class shellDetector {
    ...
    public function setDir($dir, $resFile) {
        $this->directory = $dir;
    ...
    private function flush() {    
        ...
        if (file_put_contents($filename, self::$_output)) {
            ...
            print $this->t('<div align="center">Error, report file creation failed</div>');
        }            
    }
